  ...
  return (
    <div className="py-3">
                ...
                <TableRow key={idx}>
                  ...
                  <TableCell>
                    <h5 className="text-sm">
                      {row.payment === "Success" ? (
                        <span className="bg-[#CDFDC6] text-[#04A755] px-2 py-1 rounded">
                          Paid
                        </span>
                      ) : row.payment === "Pending" ? (
                        <span className="bg-[#FCF1E6] text-[#DD8800] px-2 py-1 rounded">
                          Pending
                        </span>
                      ) : (
                        <span className="bg-[#FDEBEB] text-[#CB121D] px-2 py-1 rounded">
                          Rejected
                        </span>
                      )}
                    </h5>
                  ...
                  <TableCell>
                    <h5 className="text-sm">{row.dueDate}</h5>
                  </TableCell>
                  <TableCell>
                    <span
                      className={`${
      ...
      {showModal && selectedRow && (
        <RentModal row={selectedRow} onClose={closeModal} />
      )}
    </div>
  );
};
